...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChatStream = channel.unary_stream(
                ...
                request_serializer=chat__pb2.ChatStreamAuth.SerializeToString,
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChatStream': grpc.unary_stream_rpc_method_handler(
                    servicer.ChatStream,
                    request_deserializer=chat__pb2.ChatStreamAuth.FromString,
...
class ChatServer(object):
    ...
    def ChatStream(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/grpc.ChatServer/ChatStream',
            chat__pb2.ChatStreamAuth.SerializeToString,
